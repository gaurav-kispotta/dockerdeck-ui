  ...
  return (
    <div className="w-full h-full flex items-center justify-center relative">
      ...
      <div
        ...
        style={debugMode ? { background: 'rgba(255,256,25,0.1)', borderRadius: '50%' } : undefined}
        onMouseEnter={() => setIsHovered(true)}
        onMouseLeave={() => setIsHovered(false)}
      >
        {children}
        ...
        {handles.map((handle) => (
          <Handle
            ...
            onMouseEnter={(e) => { e.stopPropagation(); setHoveredHandleId(handle.id); }}
            onMouseLeave={(e) => { e.stopPropagation(); setHoveredHandleId(null); }}
          />
        ))}
      </div>
